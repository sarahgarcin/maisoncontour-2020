...
<?php snippet('menu') ?>
	...
	<main class='row'>
		...
		<div class="content col-xs-12 col-md-10">
			...
			<div class="content-inner actualites col-xs-12 col-md-12">
			<?php 
				...
				<?php foreach($events as $child):?>
					<article class="actualite row">
						<?php if($image = $child->cover()->toFile()):?>
							<div class="actualite_cover cover col-xs-12 col-md-3">
								<?= $image->thumb([
						      'width'   => 300,
						      'height'  => 200,
						      'quality' => 80,
					...
					<?php endif;?>
						<div class="actualite_content-wrapper col-xs-12 col-md-8">
